...
public class HibernateAccountManagerTests {
	...
	public void testUpdateAccount() {
		Account oldAccount = accountManager.getAccount(0);
		oldAccount.setName("Ben Hale");
		accountManager.update(oldAccount);
		Account newAccount = accountManager.getAccount(0);
	...
	public void testUpdateAccountBeneficiaries() {
		...
		accountManager.updateBeneficiaryAllocationPercentages(0, allocationPercentages);
		Account account = accountManager.getAccount(0);
	...
	public void testAddBeneficiary() {
		accountManager.addBeneficiary(0, "Ben");
		Account account = accountManager.getAccount(0);
	...
	public void testRemoveBeneficiary() {
		...
		accountManager.removeBeneficiary(0, "Annabelle", allocationPercentages);
		Account account = accountManager.getAccount(0);
