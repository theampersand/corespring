...
public class Restaurant {
	...
	//
	// SOLUTION:
	//    The mapping instead will occur in database specific getters and setters
	//    indicated by the @Access annotation - see end if class.  This is the
	//    most flexible way to translate between a column value and a Java object
	//    - more powerful than using @Embedded.
	//
	//    Note this is not really a transient data-member, we are just hiding it
	//    from the default JPA column mapping process.
	//
